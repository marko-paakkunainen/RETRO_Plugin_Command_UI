Public Class frmArgument
    ...
    Private Sub butFile_Click(sender As Object, e As EventArgs) Handles butFile.Click

        Dim strPath As String = gstrProjectDir & "\" & Replace(Me.Dir, "/", "\")
        ...
        If fd.ShowDialog() <> DialogResult.Cancel Then
            If fd.FileName <> "" Then
                If InStr(fd.FileName, "\") > 0 Then
                    txtValue.Text = GetFileName(fd.FileName, False)
                End If
            End If
        End If
